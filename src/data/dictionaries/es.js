...
const es = {
  ...
  profile: {
    ...
    capability:
      "De la adquisición de datos y el modelado a la evaluación y el despliegue — pipelines RAG, agentes con LangGraph y frameworks de evaluación, operados con prácticas de LLMOps.",
  ...
  about: {
    ...
    networks: [
      ...
      },
      {
        key: "dmn",
        pillar: "Humanista",
        network: "Red Neuronal por Defecto",
        color: "var(--dmn)",
